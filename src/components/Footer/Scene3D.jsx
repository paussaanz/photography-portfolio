...
const Scene3D = () => {
  ...
  return (
    ...
    >
      ...
      <pointLight position={[0, 0, 60]} intensity={5000} color={color} />
      <pointLight position={[0, 20, 60]} intensity={5000} color={color} />
      <pointLight position={[0, -20, 60]} intensity={5000} color={color} />
      <pointLight position={[-40, 10, 60]} intensity={5000} color={color} />
      <pointLight position={[40, 10, 60]} intensity={5000} color={color} />
      <pointLight position={[40, 10, 60]} intensity={5000} color={color} />
