...
const Scene3D = () => {
  ...
  const backgroundColor = isDarkMode
    ? new THREE.Color(218 / 255, 106 / 255, 45 / 255).convertSRGBToLinear()
    : new THREE.Color(52 / 255, 17 / 255, 22 / 255).convertSRGBToLinear();

  const color = isDarkMode
    ? new THREE.Color(52 / 255, 17 / 255, 22 / 255).convertSRGBToLinear()
    : new THREE.Color(0.8549, 0.4157, 0.1765).convertSRGBToLinear();
  ...
  return (
    ...
    >
      ...
      <ambientLight intensity={0.3} /> {/* Reducimos intensidad */}
