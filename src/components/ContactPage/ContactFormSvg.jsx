const ContactFormSvg = ({ focusedField }) => {
        ...
        >
            ...
            {svgs[focusedField]?.map((path) => path) || (
                <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M20.1074 38C20.1823 39.6016 20.2823 41.1045 20.3587 42.151C20.4221 43.0211 21.0514 43.7426 21.9164 43.8547C22.5205 43.9331 23.2548 44 24.0002 44C24.7455 44 25.4799 43.9331 26.0841 43.8547C26.9492 43.7426 27.5784 43.021 27.6419 42.151C27.7183 41.1044 27.8182 39.6016 27.8931 38" stroke="#DA6A2D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M10 12C5.38669 12 2.12785 15.6524 2.04181 20.2649C2.01616 21.6405 2 23.2152 2 25C2 29.4804 2.10181 32.6373 2.20017 34.6416C2.28133 36.2954 3.44665 37.6314 5.09483 37.79C6.294 37.9053 7.91386 38 10 38C12.0861 38 13.706 37.9053 14.9052 37.79C16.5534 37.6314 17.7187 36.2954 17.7998 34.6416C17.8982 32.6373 18 29.4804 18 25C18 23.2152 17.9838 21.6405 17.9582 20.2649C17.8721 15.6524 14.6133 12 10 12Z" stroke="#341116" stroke-width="2" stroke-linejoin="round" />
                    <path d="M25 2C25 2 26.1667 2 28.5 2C28.8445 2 29.1599 2.00259 29.4473 2.00702C30.8818 2.02909 32 3.06542 32 4.5C32 5.93458 30.8818 6.97091 29.4473 6.99298C29.1599 6.99741 28.8445 7 28.5 7C26.1667 7 25 7 25 7" stroke="#DA6A2D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M13 21H7" stroke="#DA6A2D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M10 12C10 12 30.6667 12 36 12C40.6133 12 43.8721 15.6524 43.9582 20.2649C43.9838 21.6405 44 23.2152 44 25C44 29.4804 43.8982 32.6373 43.7998 34.6416C43.7187 36.2954 42.5534 37.6314 40.9052 37.7899C39.706 37.9053 38.0861 38 36 38C30.6667 38 10 38 10 38" stroke="#341116" stroke-width="2" stroke-linejoin="round" />
                    <path d="M25 29V2" stroke="#DA6A2D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
