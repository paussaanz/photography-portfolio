...
import { DiscardMaterial } from './Fbo.js';
import { Text as Text$1, preloadFont } from 'troika-three-text';
import { useThree } from '@react-three/fiber';
import { suspend } from 'suspend-react';


// Default Draco decoder path
let decoderPath = 'https://www.gstatic.com/draco/versioned/decoders/1.5.5/';
let dracoLoader = null;

// Helper function to set up loader extensions
...
// Main useGLTF hook
export const useGLTF = (path, useDraco, useMeshopt, extendLoader) =>
  useLoader(GLTFLoader, path, extensions(useDraco, useMeshopt, extendLoader));

// Optional preload and clear methods
...
// Optional method to set a custom Draco decoder path
